...
public class TanningRackBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory inv, PlayerEntity player) {
        return new TanningRackScreenHandler(syncId, inv, this);
    }
    ...
    private static void craftItem(TanningRackBlockEntity entity) {
        ...
        entity.setStack(3, new ItemStack(ModItems.BANDAGE,
                entity.getStack(3).getCount() + 1));
    }

    private static boolean hasRecipe(TanningRackBlockEntity entity) {
        boolean hasItemInFirstSlot = entity.getStack(0).getItem() == ModItems.FLINT_KNIFE;
        boolean hasItemInSecondSlot = entity.getStack(1).getItem() == ModItems.FIBER;
        boolean hasItemInThirdSlot = entity.getStack(2).getItem() == ModItems.COPPER_CHESTPLATE;
