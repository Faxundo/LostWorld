...
public class ModParticles {
    ...
    public static final DefaultParticleType HIT_PARTICLE = FabricParticleTypes.simple();
    ...
    public static void registerParticles() {
        ...
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(LostWorld.MOD_ID, "stun_particle"),
                STUN_PARTICLE);
        Registry.register(Registry.PARTICLE_TYPE, new Identifier(LostWorld.MOD_ID, "hit_particle"),
                HIT_PARTICLE);
    }
}
